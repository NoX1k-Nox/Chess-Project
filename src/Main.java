...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        board.printBoard();
        while (true) {
            String currentPlayerColor = board.nowPlayerColor();
            ...
            if (s.equals("exit")) break;
                ...
                if (s.equals("castling0")) {
                    if (board.castling0(currentPlayerColor)) {
                    ...
                    if (board.castling7(currentPlayerColor)) {
                        System.out.println("Рокировка удалась");
                        board.printBoard();
                    } else {
                        System.out.println("Рокировка не удалась");
                    ...
                    try {
                        ...
                        if (board.moveToPosition(line, column, toLine, toColumn, currentPlayerColor)) {
